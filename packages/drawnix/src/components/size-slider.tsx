...
export const SizeSlider: React.FC<SliderProps> = ({
  ...
  return (
    <div
      data-tooltip
      title={title}
      className={classNames('slider-container', { disabled: disabled }, { 'has-size-indicators': showSizeIndicators })}
    >
      {showSizeIndicators && (
        <div className="slider-size-indicators">
          <div className="slider-size-indicator slider-size-indicator--min" title="最小大小" />
        </div>
      )}
      <div
        ref={sliderRef}
      ...
      {showSizeIndicators && (
        <div className="slider-size-indicators">
          <div className="slider-size-indicator slider-size-indicator--max" title="最大大小" />
        </div>
      )}
    </div>
  );
