              ...
              >
                <PopoverTrigger asChild>
                  <ToolButton
                    ...
                    title={lastFreehandButton.titleKey ? t(lastFreehandButton.titleKey as any) : 'Freehand'}
                    aria-label={lastFreehandButton.titleKey ? t(lastFreehandButton.titleKey as any) : 'Freehand'}
                    onPointerDown={() => {
...
title={button.titleKey ? t(button.titleKey as any) : 'Shape'}
                    ...
                    onPointerDown={() => {
                      ...
                      if (isShapePointer(board)) {
                        ...
                        setPointer(lastShapePointer ? lastShapePointer as DrawnixPointerType : SHAPES[0].pointer)
                        setCreationMode(board, BoardCreationMode.drawing);
                  ...
                  <ToolButton
                    ...
                    onPointerDown={() => {
                      ...
                      if (isArrowLinePointer(board)) {
                        ...
                        setPointer(lastArrowPointer ? lastArrowPointer as DrawnixPointerType : ARROWS[0].pointer);
                      }
                    }}
                  />
                </PopoverTrigger>
