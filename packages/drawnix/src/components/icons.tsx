...
// 创建图标组件的工厂函数
export const createIcon: (svg: React.ReactNode) => IconComponent = (svg) => {
  const IconComponent: IconComponent = (props) => {
    if (React.isValidElement(svg)) {
      return React.cloneElement(svg as React.ReactElement<any>, { className: props.className });
    }
    return <>{svg}</>;
  };
...
// Align Middle Vertical Icon
export const AlignMiddleOutlined = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <line x1="12" y1="3" x2="12" y2="21"></line>
    <line x1="8" y1="6" x2="8" y2="18"></line>
    <line x1="16" y1="6" x2="16" y2="18"></line>
    <rect x="6" y="8" width="4" height="8" rx="1"></rect>
    <rect x="14" y="8" width="4" height="8" rx="1"></rect>
  </svg>
);

// Element Align Left Icon - 元素左对齐
export const ElementAlignLeftIcon = createIcon(
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <line x1="4" y1="3" x2="4" y2="21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <rect x="8" y="7" width="11" height="4" rx="1" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="8" y="13" width="7" height="4" rx="1" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);

// Element Align Center Horizontal Icon - 元素水平居中对齐
export const ElementAlignCenterHIcon = createIcon(
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <line x1="12" y1="3" x2="12" y2="21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <rect x="5" y="7" width="14" height="4" rx="1" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="7" y="13" width="10" height="4" rx="1" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);

// Element Align Right Icon - 元素右对齐
export const ElementAlignRightIcon = createIcon(
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <line x1="20" y1="3" x2="20" y2="21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <rect x="5" y="7" width="11" height="4" rx="1" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="9" y="13" width="7" height="4" rx="1" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);

// Element Align Top Icon - 元素顶对齐
export const ElementAlignTopIcon = createIcon(
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <line x1="3" y1="4" x2="21" y2="4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <rect x="7" y="8" width="4" height="12" rx="1" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="13" y="8" width="4" height="8" rx="1" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);

// Element Align Center Vertical Icon - 元素垂直居中对齐
export const ElementAlignCenterVIcon = createIcon(
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <line x1="3" y1="12" x2="21" y2="12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <rect x="7" y="5" width="4" height="14" rx="1" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="13" y="7" width="4" height="10" rx="1" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);

// Element Align Bottom Icon - 元素底对齐
export const ElementAlignBottomIcon = createIcon(
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <line x1="3" y1="20" x2="21" y2="20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <rect x="7" y="4" width="4" height="12" rx="1" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="13" y="8" width="4" height="8" rx="1" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);

// Element Align Menu Icon - 对齐菜单入口图标（专用入口图标，表示对齐功能）
export const ElementAlignMenuIcon = createIcon(
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <line x1="4" y1="3" x2="4" y2="21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <rect x="8" y="7" width="10" height="3" rx="1" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="8" y="12" width="7" height="3" rx="1" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="8" y="17" width="4" height="3" rx="1" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);

// Element Distribute Horizontal Icon - 元素水平分布
export const ElementDistributeHIcon = createIcon(
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="3" y="5" width="4" height="14" rx="1" stroke="currentColor" strokeWidth="1.5"/>
...
// Element Distribute Vertical Icon - 元素垂直分布
export const ElementDistributeVIcon = createIcon(
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="5" y="3" width="14" height="4" rx="1" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="5" y="10" width="14" height="4" rx="1" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="5" y="17" width="14" height="4" rx="1" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);

// Element Distribute Menu Icon - 分布菜单入口图标
export const ElementDistributeMenuIcon = ElementDistributeHIcon;
...
export const CropOutlinedIcon = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M6.13 1L6 16a2 2 0 0 0 2 2h15"></path>
    <path d="M1 6.13L16 6a2 2 0 0 1 2 2v15"></path>
  </svg>
...
export const FileAddOutlined = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// 照片墙图标 - 四宫格合并图片
export const PhotoWallIcon = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
// 激光笔图标 - 类似激光发射器的图标
export const LaserPointerIcon = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// 钢笔图标 - 贝塞尔曲线钢笔图标
export const BezierPenIcon = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// 触控笔图标 - 手写笔
export const StylusIcon = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M18 2l4 4" />
    <path d="M17 12l-5 5" />
    <path d="M3 21l3-3" />
...
// 素材库图标 - 图片画廊
export const ImageLibraryIcon = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
