...
const enTranslations: Translations = {
  ...
  'toolbar.toolBox': 'Tool Box',
  'toolbar.mediaLibrary': 'Media Library',
  'toolbar.batchGenerate': 'Batch Generate',
  ...
  'popupToolbar.fontFamily': 'Font Family',
  'popupToolbar.bold': 'Bold',
  'popupToolbar.italic': 'Italic',
  'popupToolbar.underline': 'Underline',
  'popupToolbar.strikethrough': 'Strikethrough',
  'popupToolbar.smartSplit': 'Smart Split',
  'popupToolbar.mergeToPhotoWall': 'Merge to Photo Wall',
  'popupToolbar.crop': 'Crop',

  // Text effect translations
  'textEffect.shadow': 'Shadow',
  'textEffect.gradient': 'Gradient',
  'textEffect.stroke': 'Stroke',
  'textEffect.glow': 'Glow',
  'textEffect.shadowColor': 'Shadow Color',
  'textEffect.blur': 'Blur',
  'textEffect.offset': 'Offset',
  'textEffect.angle': 'Angle',
  'textEffect.startColor': 'Start Color',
  'textEffect.endColor': 'End Color',
  'textEffect.strokeColor': 'Stroke Color',
  'textEffect.strokeWidth': 'Stroke Width',
  'textEffect.glowColor': 'Glow Color',
  'textEffect.glowBlur': 'Glow Blur',
