...
const zhTranslations: Translations = {
  ...
  'popupToolbar.bold': '粗体',
  'popupToolbar.italic': '斜体',
  'popupToolbar.underline': '下划线',
  'popupToolbar.strikethrough': '删除线',
  'popupToolbar.smartSplit': '智能拆图',
  'popupToolbar.mergeToPhotoWall': '合并为照片墙',
  'popupToolbar.crop': '裁剪',

  // Text effect translations
  'textEffect.shadow': '阴影',
  'textEffect.gradient': '渐变',
  'textEffect.stroke': '描边',
  'textEffect.glow': '发光',
  'textEffect.shadowColor': '阴影颜色',
  'textEffect.blur': '模糊',
  'textEffect.offset': '偏移',
  'textEffect.angle': '角度',
  'textEffect.startColor': '起始颜色',
  'textEffect.endColor': '结束颜色',
  'textEffect.strokeColor': '描边颜色',
  'textEffect.strokeWidth': '描边宽度',
  'textEffect.glowColor': '发光颜色',
  'textEffect.glowBlur': '发光模糊',
